...
The application version is **1.1.3**. Android workflows produce an installable
APK. The iOS workflow produces an unsigned device IPA for development
sideloading; App Store distribution requires Apple signing credentials.
